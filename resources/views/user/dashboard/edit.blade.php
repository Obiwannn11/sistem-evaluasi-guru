...
<div class="card shadow p-3">
    ...
    <form action="{{ route('dashboard.update', $user->id) }}" method="post" id="form" enctype="multipart/form-data">
        @csrf
        <div class="row mb-3">
            ...
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nama" name="nama" required value="Mustikasari">
                </div>
                <div class="mb-3">
        ...
        <a class="btn btn-warning" href="admin/dashboard" role="button">Cancel</a>
