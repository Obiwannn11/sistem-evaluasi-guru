...
<div class="card shadow p-3">
    ...
    <div class="mb-3">
        <a class="btn btn-primary" href="admin/file/tambah.php" role="button">Tambah</a>
    </div>
                ...
                <?php //foreach ($file as $row) : ?>
                    <tr>
                        ...
                        <td class="text-center text-nowrap">
                            ...
                            <a class="btn btn-warning me-1" href="admin/file/ubah.php?id=" role="button"><i class='bi bi-pencil-square'></i></a>
